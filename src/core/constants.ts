...
export const MEASUREMENT_ORDER: readonly MeasurementSlotId[] = [
  "M03", "M01", "M06", "M02", "L02",
  "M05", "M09", "M11", "M04", "L03",
...
export const DIAGNOSTIC_AXES: readonly DiagnosticAxis[] = [
  "STR", "CON", "SIZ", "DEX", "APP",
...
export type KnownClueId = keyof typeof CLUE_REGISTRY;
...
export const FIXATION_CLUES = new Set<string>([
...
export const STOP_CLUES = new Set<string>([
  "formal_server_log",
  "phase_waveform",
  "emergency_power_log",
  "oscillator_map",
...
export const SEAL_CLUES = new Set<string>([
...
export const NETWORK_CLUES = new Set<string>([
  "facility_locations",
