...
function createDiagnosticAxisState() {
    return {
        evidenceSum: 0,
        informationSum: 0,
        validObservations: 0,
...
function createDiagnosticState() {
    return Object.fromEntries(DIAGNOSTIC_AXES.map((axis) => [axis, createDiagnosticAxisState()]));
}
export function createInitialState(sessionSeed = "demo-seed") {
    return {
        story: {
            act: 1,
            currentSlot: "M03",
